...
Dirt Box is a thing. Dirt Box is a container.
Dirt Box is in Food Stands.
Instead of examining Dirt Box, say "You see the top of a spuddy's head. From what you can tell, it looks like Bean."
Bean is a thing. Bean is inside Dirt Box.
...
Haystack is a thing.
[figure out how to randomize lines when examining haystack(s)]